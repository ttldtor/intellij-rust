...
class PyActiveSdkConfigurable private constructor(private val project: Project, private val module: Module?) : UnnamedConfigurable {
    ...
    companion object {
        private val LOG = Logger.getInstance(PyActiveSdkConfigurable::class.java)
